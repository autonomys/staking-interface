...
const titleDefault = 'Subspace Staking Interface'
const url = 'https://staking-interface.subspace.network'
const description = 'Subspace Staking Interface'
const keywords = 'subspace,staking'
