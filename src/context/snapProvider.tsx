...
export const MetaMaskContext = createContext<[MetamaskState, Dispatch<MetamaskDispatch>]>([initialState, () => null])
...
export const SnapContextProvider = (props: PropsWithChildren<Record<string, unknown>>): React.JSX.Element => {
